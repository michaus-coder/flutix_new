  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        ...
        context
            .watch<PageBloc>()
            .add(GoToRegistrarionPage(widget.registrationData));
        return true;
      },
      child: Scaffold(
        body: Container(
                    ...
                    child: GestureDetector(
                        onTap: () {
                          ...
                          context.watch<PageBloc>().add(
                              GoToRegistrarionPage(widget.registrationData));
                        },
    ...
    return widget.genres
        .map((e) => SelectableBox(
              ...
              textStyle: whiteNumberFont.copyWith(
                color: selectedGenres.contains(e) ? Colors.black : Colors.white,
              ),
            ))
        .toList();
  }
  ...
  List<Widget> generateLangWidgets(BuildContext context) {
    ...
    return widget.languages
        .map((e) => SelectableBox(
              ...
              textStyle: whiteNumberFont.copyWith(
                color: selectedLanguage == e ? Colors.black : Colors.white,
              ),
            ))
        .toList();
  }
